			...
			<>
			 <link rel="preconnect" href="https://fonts.gstatic.com" />
              ...
              <header>
				...
				<div className="box">
				<td className="col"><img src="img/decor2.jpg" width="400" height="400" alt="Decor" /></td>
				<td className="text">Чтобы придать интерьеру законченный вид,широко используется архитектурный декор. Известно, что в классическом дизайне без декора
