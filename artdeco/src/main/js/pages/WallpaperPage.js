	...
	render() {
		return (
			...
			<link rel="preconnect" href="https://fonts.gstatic.com" />
				...
				<div className="text">
                                <p>Мы предлагаем обои премиального качества с самыми разнообразными принтами, и вы сможете найти что-то
                                для себя, какой бы дизайн вы ни выбрали: от классического барокко до современного лофта. Продукция,
                                которую мы предоставляем, соответствует российским и международным санитарным требованиям и стандартам качества.</p>
                                </div>
				<footer>
